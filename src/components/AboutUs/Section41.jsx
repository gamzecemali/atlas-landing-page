...
const Section41 = () => {
  ...
  const Card = () => (
    <div 
      className='w-full max-w-[280px] xs:max-w-[300px] sm:max-w-[350px] md:max-w-[280px] lg:max-w-[320px] xl:max-w-[384px] h-auto min-h-[160px] xs:min-h-[180px] sm:min-h-[200px] md:min-h-[220px] lg:min-h-[240px] rounded-xl p-3 xs:p-4 sm:p-5 lg:p-6 relative mx-auto z-10'
      style={{
        background: '#0C0C0F',
  ...
  return (
    <div className='relative min-h-[90vh] sm:min-h-[90vh] md:min-h-[80vh] w-full bg-black overflow-hidden py-6 sm:py-8 md:py-12 lg:py-16 pb-0 sm:pb-0 md:pb-0'>
      {/* Main container with flex layout */}
      <div className='w-full h-full flex flex-col md:flex-row relative'>
        {/* Animated circles - centered in the container */}
        <div className='absolute inset-0 z-0 pointer-events-none flex items-center justify-center'>
          <AnimatedCircles />
        </div>
        
        {/* Mobile and tablet layout (2x2 grid) */}
        <div className='md:hidden w-full z-10 px-4 sm:px-8 py-4 sm:py-6'>
        ...
        <div className='hidden md:flex w-full h-full md:flex-row md:items-center px-3 xs:px-4 sm:px-8 md:px-12 lg:px-16 xl:px-[60px] 2xl:px-[80px] 3xl:px-[120px] z-10'>
          {/* Left column */}
          <div className='flex flex-col gap-8 lg:gap-12 xl:gap-[120px] 2xl:gap-[157px] w-full md:w-1/2'>
            <Card />
            <Card />
          </div>
