    ...
    <div className='relative h-screen w-full bg-black'>
      ...
      <div className='absolute bottom-8 left-1/2 transform -translate-x-1/2 flex flex-col items-center justify-center'>
        ...
        <button 
          ...
          className='animate-bounce rounded-full p-3  transition-colors duration-200 shadow-lg hover:shadow-xl transform hover:scale-105 transition-transform'
          aria-label="Scroll to next section"
        >
          <img src={mouseIcon} alt="Scroll down" className='w-5 h-7' />
        </button>
      </div>
    </div>
  )
